          ...
          <div className="bg-slate-50">
            ...
            <section className="relative overflow-hidden py-20 px-6 bg-gradient-to-r from-[#031D33] via-[#0B2545] to-[#134074] text-white">
              ...
              <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-12 items-center relative">
                ...
                {/* Right Column: Responsável Técnico Description Card (No Photo) */}
                <div className="lg:col-span-5 relative flex items-center justify-center pt-8 lg:pt-0">
                  <div className="w-full relative z-10 bg-slate-900/80 backdrop-blur-md border border-slate-700/50 rounded-2xl p-6 shadow-2xl space-y-5">
                    
                    {/* Header badge */}
                    <div className="flex items-center justify-between border-b border-slate-800 pb-4">
                      <div className="flex items-center gap-2.5">
                        <div className="w-10 h-10 rounded-xl bg-[#155E54]/20 border border-[#155E54]/50 flex items-center justify-center text-emerald-400 shadow-sm">
                          <Shield className="w-5 h-5 text-emerald-400" />
                        </div>
                        <div>
                          <p className="text-[10px] font-mono text-emerald-400 font-bold uppercase tracking-wider">Engenharia Habilitada</p>
                          <p className="text-xs font-bold text-slate-200">RESPONSÁVEL TÉCNICO</p>
                        </div>
                      </div>
                      <span className="inline-flex items-center gap-1 text-[10px] font-mono bg-emerald-500/10 text-emerald-400 border border-emerald-500/30 px-2.5 py-1 rounded-full font-semibold">
                        <CheckCircle className="w-3 h-3" /> REGISTRO ATIVO
                      </span>
                    </div>

                    {/* Engineer Name & Title */}
                    <div>
                      <h4 className="text-xl font-bold text-white tracking-tight">Eng. Josnei da Cunha</h4>
                      <p className="text-xs text-slate-400 font-medium mt-0.5">Engenheiro Mecânico e Especialista em Engenharia de Segurança</p>
                    </div>

                    {/* Technical Specs List */}
                    <div className="bg-slate-950/70 border border-slate-850 p-4 rounded-xl space-y-2.5 font-mono text-xs">
                      <div className="flex justify-between items-center text-slate-300 border-b border-slate-900 pb-2">
                        <span className="text-slate-500 text-[11px]">CREA:</span>
                        <span className="font-bold text-emerald-400">{siteSettings.crea}</span>
                      </div>
                      <div className="flex justify-between items-center text-slate-300 border-b border-slate-900 pb-2">
                        <span className="text-slate-500 text-[11px]">CNPJ da Empresa:</span>
                        <span className="font-semibold text-slate-200">{siteSettings.cnpj || "53.111.432/0001-36"}</span>
                      </div>
                      <div className="flex justify-between items-center text-slate-300 border-b border-slate-900 pb-2">
                        <span className="text-slate-500 text-[11px]">Jurisdição Nacional:</span>
                        <span className="text-slate-200">CONFEA / CREA-MS</span>
                      </div>
                      <div className="flex justify-between items-center text-slate-300">
                        <span className="text-slate-500 text-[11px]">Cobertura Técnica:</span>
                        <span className="text-slate-200">Aparecida do Taboado & Todo Brasil</span>
                      </div>
                    </div>

                    {/* Badges / Competencies */}
                    <div className="space-y-2 pt-1">
                      <p className="text-[10px] font-mono uppercase tracking-wider text-slate-400 font-semibold">Atribuições Principais:</p>
                      <div className="grid grid-cols-2 gap-2 text-[11px]">
                        <div className="bg-slate-800/60 border border-slate-700/50 px-3 py-2 rounded-lg text-slate-200 flex items-center gap-1.5">
                          <Wrench className="w-3.5 h-3.5 text-emerald-400 shrink-0" />
                          <span className="truncate">Laudos NR-12 & NR-13</span>
                        </div>
                        <div className="bg-slate-800/60 border border-slate-700/50 px-3 py-2 rounded-lg text-slate-200 flex items-center gap-1.5">
                          <ClipboardList className="w-3.5 h-3.5 text-emerald-400 shrink-0" />
                          <span className="truncate">Emissão de ART Definitiva</span>
                        </div>
                        <div className="bg-slate-800/60 border border-slate-700/50 px-3 py-2 rounded-lg text-slate-200 flex items-center gap-1.5">
                          <Eye className="w-3.5 h-3.5 text-emerald-400 shrink-0" />
                          <span className="truncate">Inspeções Periódicas</span>
                        </div>
                        <div className="bg-slate-800/60 border border-slate-700/50 px-3 py-2 rounded-lg text-slate-200 flex items-center gap-1.5">
                          <FileText className="w-3.5 h-3.5 text-emerald-400 shrink-0" />
                          <span className="truncate">Projetos & Estruturas</span>
                        </div>
                      </div>
                    </div>

                    {/* Footer Trust Callout */}
                    <div className="bg-emerald-950/20 border border-emerald-500/20 p-3 rounded-xl flex items-center gap-2.5 text-emerald-300 text-[11px]">
                      <Sparkles className="w-4 h-4 text-emerald-400 shrink-0" />
                      <span>Todos os laudos acompanham Anotação de Responsabilidade Técnica (ART) com assinatura digital válida.</span>
                    </div>
